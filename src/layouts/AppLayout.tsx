...
const NAV_ITEMS: NavItem[] = [
  ...
  { name: 'Production', path: '/production', icon: Wrench, permission: 'production:view' },
  { name: 'Inventory', path: '/inventory', icon: Package, permission: 'inventory:view' },
  { name: 'Payments', path: '/payments', icon: CreditCard, permission: 'payments:view' },
  { name: 'Deliveries', path: '/deliveries', icon: Truck, permission: 'deliveries:view' },
  { name: 'Employees', path: '/employees', icon: Users, permission: 'employees:view' },
  { name: 'Photographers', path: '/photographers', icon: Camera, permission: 'photographers:view' },
  { name: 'Attachments', path: '/attachments', icon: Paperclip, permission: 'attachments:view' },
        ...
        <div className="flex h-16 items-center justify-between px-4 border-b border-border">
          {!collapsed && (
            <Link to="/" className="flex items-center gap-2">
              <span className="text-lg font-bold tracking-tight text-primary">Colour Lab ERP</span>
            </Link>
          )}
          <button
            onClick={toggle}
        ...
        <div className="fixed inset-0 z-40 md:hidden flex">
          ...
          <aside className="relative flex w-64 max-w-xs flex-col bg-card border-r border-border h-full p-4 animate-in slide-in-from-left duration-200">
            <div className="flex h-12 items-center justify-between border-b border-border pb-2 mb-4">
              <span className="text-lg font-bold text-primary">Colour Lab ERP</span>
              <button
